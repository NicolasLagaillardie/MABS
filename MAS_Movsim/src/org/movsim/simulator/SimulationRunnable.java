...
public class SimulationRunnable extends SimulationRun implements Runnable {
     ...
     * new version
     */
    //private ArrayList<UpdateDrawingCallback> updateDrawingCallbacks = new ArrayList<UpdateDrawingCallback>();
     ...
     * new version
     */
    /*public void addUpdateDrawingCallback(UpdateDrawingCallback updateDrawingCallback) {
       //assert this.updateDrawingCallback == null; // it's a mistake if this is set twice
       
    	//System.out.println("add call back");
    	//System.out.println(updateDrawingCallback);
    	this.updateDrawingCallbacks.add(updateDrawingCallback);
    }
    /**
     * needed counter method
     */
    /*
     public void removeUpdateDrawingCallback(UpdateDrawingCallback updateDrawingCallback) {
        //assert this.updateDrawingCallback == null; // it's a mistake if this is set twice
    ...
    */
    ...
    public void run() {
        ...
        while (Thread.currentThread() == thread) {
            ...
            try {
                // commented for TP Thread.sleep(sleepTimeUsed); TIMER
            	Thread.sleep(100);
            } catch (final InterruptedException e) {
                // ignore exception
            }
             ...
             * new version
             */
            //for(UpdateDrawingCallback updateDrawingCallback : this.updateDrawingCallbacks){
